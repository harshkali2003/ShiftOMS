...
const { getAllProductService, postProductService, updateProductService } = require("./products.service")
...
exports.getAllProductController = async (req , resp , next) => {
    try{
        ...
        const {count , products} = await getAllProductService(filter , skip , limitNum);
...
exports.postProductController = async (req , resp , next) => {
    try{
        ...
        if(!name || !info || !actualPrice || typeof(actualPrice) !== "number" || actualPrice < 0 || !stock || typeof(stock) !== "number" || stock < 1){
